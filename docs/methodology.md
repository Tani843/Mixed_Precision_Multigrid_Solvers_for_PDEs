...
$k_{\text{switch}} = \arg \min_k \left[ k \cdot C_{\text{fp32}} + (K-k) \cdot C_{\text{fp64}} + C_{\text{conversion}} \right]$
...
**Mixed-Precision Performance Model:** The speedup from mixed precision is modeled as: 
